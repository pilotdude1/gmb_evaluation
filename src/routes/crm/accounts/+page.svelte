...
<div class="px-4 sm:px-6 lg:px-8">
  ...
  <div class="sm:flex sm:items-center sm:justify-between mb-8">
    <div>
      ...
      <p class="mt-2 text-gray-600 dark:text-gray-300">Manage your business accounts and prospects</p>
    </div>
  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div>
        <label for="business-type" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Type</label>
        <select
          id="business-type"
              ...
              <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                  <div>
                    ...
                    {/if}
                    {#if account.phone}
                      <div class="text-gray-500 dark:text-gray-400">{formatPhone(account.phone)}</div>
                    {/if}
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div class="flex space-x-2">
                    ...
                    <a href="/crm/accounts/{account.id}/edit" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200">Edit</a>
                  </div>
                </td>
              </tr>
            {/each}
